...
class BookingController extends Controller
{
    ...
    public function selectDate(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if (
                !$request->has(['don_vi_id', 'dich_vu_id']) ||
    ...
    public function uploadForm(Request $request)
    {
        ...
        if ($request->isMethod('post')) {
            ...
            if (
                !$request->has(['don_vi_id', 'dich_vu_id', 'ngay_hen', 'gio_hen']) ||
    ...
    private function getAvailableDates($schedules, $servicePhuong, $days = 30, $startDays = 14)
    {
        ...
        // $startDays ngày (mặc định 14 ngày = 2 tuần)
        ...
        for ($i = 0; $i < $days; $i++) {
            ...
            $thuTrongTuan = $carbonDayOfWeek == 0 ? 7 : $carbonDayOfWeek; // Chuyển từ 0 -> 7
