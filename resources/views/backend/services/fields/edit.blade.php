            ...
            <div class="page-header d-flex justify-content-between align-items-center">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('services.edit', $service->id) }}">{{ $service->ten_dich_vu }}</a></li>
                ...
                <div class="col-lg-10">
                    <div class="card shadow-sm border-0">
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('services.fields.update', [$service->id, $field->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
