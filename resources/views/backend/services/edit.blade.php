                ...
                <div class="col-lg-8">
                    ...
                    <div class="card shadow-sm border-0 mt-4">
                        <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('services.fields.create', $service->id) }}" class="btn btn-light btn-sm">
                        ...
                        <div class="card-body p-4">
                                        ...
                                        <tbody>
                                            @foreach($service->serviceFields as $index => $field)
                                                <tr>
                                                    ...
                                                    <td>{{ $field->thu_tu }}</td>
                                                    <td>
                                                        <a href="{{ route('services.fields.edit', [$service->id, $field->id]) }}" 
                                                           class="btn btn-sm btn-warning">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form action="{{ route('services.fields.destroy', [$service->id, $field->id]) }}" 
                                                              method="POST" 
                                                              class="d-inline"
                            ...
                            @else
                                <div class="alert alert-info text-center">
                                    ...
                                    <a href="{{ route('services.fields.create', $service->id) }}" class="alert-link">Thêm trường đầu tiên</a>
                                </div>
                            @endif
                        </div>
                    </div>
